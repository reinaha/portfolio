import AirNZNextGenKioskAirportValidationBoardingPass from '@resources/AirNZNextGenKiosk/AirportValidationBoardingPass.jpg';
import AirNZNextGenKioskAirportValidationInsightsFramework from '@resources/AirNZNextGenKiosk/AirportValidationInsightsFramework.jpg';
import AirNZNextGenKioskAirportValidationOne from '@resources/AirNZNextGenKiosk/AirportValidationOne.jpg';
import AirNZNextGenKioskAirportValidationPassportScan from '@resources/AirNZNextGenKiosk/AirportValidationPassportScan.jpg';
import AirNZNextGenKioskDiscovery01 from '@resources/AirNZNextGenKiosk/Discovery01.jpg';
import AirNZNextGenKioskDiscovery02 from '@resources/AirNZNextGenKiosk/Discovery02.jpg';
import AirNZNextGenKioskDiscovery03 from '@resources/AirNZNextGenKiosk/Discovery03.jpg';
import AirNZNextGenKioskDiscoveryCover from '@resources/AirNZNextGenKiosk/DiscoveryCover.jpg';
...
import AirNZNextGenKioskSolutionAdaptiveJourneyStepOne from '@resources/AirNZNextGenKiosk/SolutionAdaptiveJourneyStepOne.jpg';
import AirNZNextGenKioskSolutionAdaptiveJourneyStepTwo from '@resources/AirNZNextGenKiosk/SolutionAdaptiveJourneyStepTwo.jpg';
import AirNZNextGenKioskSolutionPhysicalDigitalStepOne from '@resources/AirNZNextGenKiosk/SolutionPhysicalDigitalStepOne.jpg';
import AirNZNextGenKioskSolutionPhysicalDigitalStepTwo from '@resources/AirNZNextGenKiosk/SolutionPhysicalDigitalStepTwo.jpg';
import AirNZNextGenKioskSolutionStakeholdersOperationalVisibility from '@resources/AirNZNextGenKiosk/SolutionStakeholdersOperationalVisibility.jpg';
import AirNZNextGenKioskSolutionStakeholdersRestrictedItems from '@resources/AirNZNextGenKiosk/SolutionStakeholdersRestrictedItems.jpg';
...
export { AirNZNextGenKioskDiscoveryCover };

export { AirNZNextGenKioskProjectContextProblem };

export {
    AirNZNextGenKioskDiscovery01,
    AirNZNextGenKioskDiscovery02,
    AirNZNextGenKioskDiscovery03,
};

export { AirNZNextGenKioskStructureOneDiagram, AirNZNextGenKioskStructureTwoDiagram };

export { AirNZNextGenKioskInternalValidationOne, AirNZNextGenKioskInternalValidationTwo };

export {
    AirNZNextGenKioskAirportValidationBoardingPass,
    AirNZNextGenKioskAirportValidationInsightsFramework,
    AirNZNextGenKioskAirportValidationOne,
